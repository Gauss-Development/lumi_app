...
class RemoveKeptLumiUseCase {
  const RemoveKeptLumiUseCase(this._repository);

  final ShelfRepository _repository;

  Future<Either<Failure, List<KeptLumi>>> call(String lumiId) {
    return _repository.removeKeptLumi(lumiId);
  }
}
